...
# SexWork.us build configuration file, created by
# `ablog start` on Fri Oct 21 17:00:22 2016.
#
...
blog_authors = {
	'sexwork.us contributors': ('sexwork.us contributors', None),
}
...
project = u'SexWork.us'
copyright = u'2016, sexwork.us contributors'
author = u'sexwork.us contributors'
...
version = time.strftime("%a, %d %b %Y %H:%M:%S +0000", time.gmtime())
# The full version, including alpha/beta/rc tags.
release = time.strftime("%a, %d %b %Y %H:%M:%S +0000", time.gmtime())
...
htmlhelp_basename = 'SexWorkusdoc'
...
Copyright (c) 2014-2015 Lasagne contributors"""
	...
	url = "https://github.com/sexwork/sexwork/blob/%s/%s.py" % (tag, filename)
	try:
